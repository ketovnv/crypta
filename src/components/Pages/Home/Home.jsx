...
import AppKitAccountObserver from "@/stores/AppKitHooks/hookStores/AcountStore.js";
...
const Home = observer(() => {
    ...
    return (
        <div>        {/* Компоненты-наблюдатели */}
            <AppKitStateObserver/>


            <AppKitAccountObserver/>

            {/* Используем данные из store */}
            {appKitStore.account?.isConnected && (
                <div>
                    Адрес кошелька: {appKitStore.account.address}
                </div>
            )}
        </div>
    );
