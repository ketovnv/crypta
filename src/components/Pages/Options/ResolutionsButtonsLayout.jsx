...
const ResolutionsButtonsLayout = ({width,height,mode}) => {
    ...
    const resizeWindow = (res) => {
        ...
        console.log(`Применяем разрешение: ${res[0]}x${res[1]}`);
        console.log(windowStore.unlistenWindow);
    ...
    const selectedVariants = {
        ...
        selected: {
            ...
            transition: {duration: 2, scale: {duration: 4}, fontWeight: {delay: 2, duration: 1}} // Экспоненциальная кривая для плавности
        }
    };
    ...
    const ResolutionButton = ({res, isSelected, position = "row", onClick}) => {
        return (
            <motion.div
                ...
                transition={{duration: 0.5, layout: {duration: 0.5, ease: "easeInOut"}}}
            >
        ...
        <div style={styles.container}>
                ...
                <div style={styles.resolutionContainer}>
                    <LayoutGroup id="resolutions">
                        ...
                        <span>{width}</span>
                        <span>{height}</span>
                        <div style={styles.selectedResolutionContainer} key={'container' + uiStore.themeIsDark}>
                                <ResolutionButton
                                    key={`selected-${width}}`}
                                    res={[width,height]}
                                    isSelected={true}
