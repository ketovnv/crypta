...
export  function Web3Inch({color1, color2,isDark=true}) {
const dx=isDark?.3:.6;
   ...
   return(
       <motion.svg layout xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                   width='15em'
                   height='15em'
                   style={{
                       "--shadow-color-1": "initial", //for correct work with initial render
                       "--shadow-opacity-1": "initial",
                       "--shadow-color-2": "initial",
                       "--shadow-opacity-2": "initial",
                       "--shadow-color-3": "initial",
                       "--shadow-opacity-3": "initial",
                   }}
       ...
       >
           <motion.filter id="shadow" x="0" y="0" width="200%" height="200%">
               <motion.feDropShadow layout
                                    dx={dx}
                                    dy="0.3"
                                    stdDeviation="0.5"
                                    floodColor="var(--shadow-color-1)"
                                    floodOpacity="var(--shadow-opacity-1)"
               />
               <motion.feDropShadow layout
                                    dx={dx}
                                    dy="0.7"
                                    stdDeviation="0.7"
                                    floodColor="var(--shadow-color-3)"
                                    floodOpacity="var(--shadow-opacity-3)"
               />
               <motion.feDropShadow layout
                                    dx={dx}
                                    dy="0.5"
                                    stdDeviation="0.3"
                                    floodColor="var(--shadow-color-2)"
                                    floodOpacity="var(--shadow-opacity-2)"
               />
               {/*<motion.feDropShadow  animate={isDark? 'dark': 'light' }   transition={{duration: 5, ease: "easeInOut"}} variants={filterFirstAnimations}  dy="0.3" stdDeviation="0.5"   />*/}
               {/*<motion.feDropShadow animate={isDark? 'dark': 'light' }    transition={{duration: 5, ease: "easeInOut"}} variants={filterSecondAnimations}  dy="0.5" stdDeviation="0.3" />*/}
               {/*<motion.feDropShadow animate={isDark? 'dark': 'light' }   transition={{duration: 5, ease: "easeInOut"}}  variants={filterThreeAnimations} dy="0.7" stdDeviation="0.7"  />*/}
           </motion.filter>
            <defs>
