...
export const Web3Inch = ({isDark = true, variants}) => {
    const {fill, scale, color1, color2, offset1, offset2} = useSpring({
        fill: isDark ? "#0049f3" : "#000000",
        color1: isDark ? "hsl(0 100% 50%)" : "hsl(53.28 100% 50%)",
        color2: isDark ? "hsl(52.34 91% 70%)" : "hsl(0 100% 45%)",
        offset1: isDark ? "20%" : "5%",
        offset2: isDark ? "85%" : "95%",
    scale: isDark ? 1 : 0.5,
        config: {
            tension: 50, friction: 50, mass: 10, damping: 10, precision: 0.0001,
        },
  });

    return (<motion.section variants={variants} transition={{type: "spring", stiffness: 50, friction: 100, mass: 5, damping: 25}}>
            <MotionConfig transition={{type: "spring", stiffness: 50, friction: 15, mass: 15, damping: 10}}>
    <motion.svg
        initial={{rotate: -720}}
        whileHover="hover"
        whileTap={{scale: 0.55, rotate: 720, y: [-25, -15]}}
      key="horse"
    ...
    >
      ...
      <defs>
          <linearGradient id="grad1" x1="0%" x2="100%" y1="0%" y2="0%">
              <animated.stop offset={offset1} stopColor={color2}/>
              <animated.stop offset={offset2} stopColor={color1}/>
          </linearGradient>
