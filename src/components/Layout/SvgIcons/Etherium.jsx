...
export const Etherium = observer((props) => {
    ...
    return (
        <MotionConfig  transition={{
            ...
            <motion.svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 784.3699951171875 1277.3800048828125"
                 {...props}
            >

        <motion.g   xmlns="http://www.w3.org/2000/svg" id="_1421394342400">
            <motion.g    animate={{scale: uiStore.themeIsDark? 1:0.9,fill: animation.theme.color}}>
                <motion.polygon  animate={{fill: animation.theme.color}} fillRule="nonzero"
                ...
                < motion.polygon  animate={{fill: animation.theme.color}} fillRule="nonzero" points="0,650.54 392.07,882.29 392.07,472.33 "/>
            </motion.g>
        </motion.g>
            </motion.svg>
        </MotionConfig>)
