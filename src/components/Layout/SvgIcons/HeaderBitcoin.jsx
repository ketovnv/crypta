    ...
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 48 48" width={width} height={height}>
        <g fill="none">
            <circle cx="24" cy="24" r="20" fill="#2F88FF" stroke="#000" strokeLinecap="round"
                    ...
                    strokeWidth="4"/>
            <path fill="#2F88FF" d="M20 16H25H27C29.2091 16 31 17.7909 31 20C31 22.2091 29.2091 24 27 24H20V16Z"/>
            ...
            <path fill="#2F88FF" d="M20 24H29C31.2091 24 33 25.7909 33 28C33 30.2091 31.2091 32 29 32H25H20V24Z"/>
            <path stroke="#fff" strokeLinecap="round" strokeLinejoin="round" strokeWidth="4"
