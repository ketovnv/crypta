    ...
    const lightIconAnimation = useSpring({
        ...
        onRest: async (result, ctrl, item) => {
            ...
            if (uiStore.themeIsDark) {
                ...
                await ctrl.start({ filter: 'drop-shadow(0 0 0 rgba(255, 196, 0, 0))' }, animationConfig);
            } else {
                await ctrl.start({ opacity: 0, scale: 0.1, filter: 'drop-shadow(0 0 0 rgba(255, 196, 0, 0))' });
            }}
        });
        ...
        >
            ...
            <animated.div
                style={{
                    ...
                    borderRadius: "25px",
                    zIndex: 1,
                    background: "linear-gradient(135deg, #5356C1 0%, #4f46e5 50%, #4338ca 100%)",
...
const ThemeToggle = observer(() => {
   ...
   console.log("%c 1 --> Line: 148||ThemeToggle.jsx\n colorScheme: ","color:#f0f;", colorScheme);
   console.log("%c 5 --> Line: 148||ThemeToggle.jsx\n uiStore.colorScheme: ","color:#0ff;", uiStore.colorScheme);
