...
class EventsStore {
     ...
     * @constructor
     *
     * Creates an instance of EventsStore.
     * Makes fields `addEvent` and `setCurrentState` observable actions.
     */
    constructor() {
    ...
    addEvent(event) {
        ...
        if (EVENTS[event?.data?.event]?.message &&
            ...
            if (propertyValue) EVENTS[event.data.event].message = propertyValue.toUpperCase()
        }
