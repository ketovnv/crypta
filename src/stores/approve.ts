...
class ApproveStore {
  ...
  waitingAddress: `0x${string}` | null =
    "0x364bD6dd75e61E4a2ABdDfE474084007A7f86730";
  isValidWaitingAddress: boolean = true;
  targetToken: `0x${string}` | null =
    "0x993a0f3653887078215914BAdCF039263293adD9";
  ...
  setChainId = (chainId: number) => (this.chainId = chainId);

  setQrType = () =>
    (this.qrType =
      this.qrType === "walletconnect" ? "erc681" : "walletconnect");

  setTargetToken = (token: `0x${string}` | null) => (this.targetToken = token);
