...
export const createNoiseSVG = (baseFreq, numOctaves, seed = 0) =>
  `url("data:image/svg+xml,%3Csvg viewBox='0 0 400 400' xmlns='http://www.w3.org/2000/svg'%3E%3Cfilter id='noiseFilter'%3E%3CfeTurbulence type='fractalNoise' baseFrequency='${baseFreq}' numOctaves='${numOctaves}' seed='${seed}' stitchTiles='stitch'/%3E%3C/filter%3E%3Crect width='100' height='100' filter='url(noiseFilter)'/%3E%3C/svg%3E")`;
